...
const FeaturedProjects = () => {
  ...
  return (
    <>
                ...
                >
                  ...
                  >
                    ...
                    <div className="px-8 pb-8 relative z-10">
                      <span className="inline-flex items-center gap-2 text-brand-blue font-bold text-xl uppercase tracking-wider group-hover:gap-4 transition-all">
                        View Project <ChevronRight size={16} />
                      </span>
                    </div>
                  </Link>
                  {/* ✅ Kart içindeki duplicate overlay tamamen kaldırıldı */}
                </motion.div>
              ))}
            </AnimatePresence>
          </div>
      ...
      {/* ✅ Tek ve doğru overlay — section dışında, en üst seviyede */}
