      ...
      >
        ...
        {[
          ...
          },
          {
            ...
            body: "When you use the AI chat assistant, your questions and the assistant's responses may be logged. Each session is assigned a random, anonymous session ID — no personally identifiable information (IP address...) is collected or stored.",
          },
          {
          ...
          {
            title: "Contact",
            body: "For any privacy-related questions or requests, please reach out at: yasir7alrawi23@gmail.com",
          },
        ].map((section, i) => (
